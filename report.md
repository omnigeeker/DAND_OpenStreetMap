...
从前面用户数的情况看，用户贡献并不是非常积极的。
贡献数据最多的前10个人，贡献的数据是 997873，占总数 1355351 的 73.6%。
再次建议openstreetmap可以采用一些心里奖励的机制来鼓励用户更多地贡献数据，例如搞个排行版，给些徽章等等方式。让贡献数据的人更容易让大家指导。
